...
const domainCards = [
  {
    ...
    icon: FileText,
    href: "/dashboard/probis" as const,
    color: "text-blue-500",
  ...
  },
  {
    ...
    href: "/dashboard/aplikasi" as const,
  ...
  },
  {
    ...
    icon: Server,
    href: "/dashboard/infrastruktur" as const,
  ...
  },
  {
    ...
    icon: Network,
    href: "/dashboard/layanan" as const,
    color: "text-cyan-500",
  ...
  },
  {
    ...
    icon: Lock,
    href: "/dashboard/keamanan" as const,
    color: "text-red-500",
...
function DomainCard({
  ...
  description: string;
  icon: ElementType;
  href: (typeof domainCards)[number]["href"];
  color: string;
  bgColor: string;
  count?: number;
}) {

...
import { ProbisDeleteDialog } from "@/components/dashboard/probis/probis-delete-dialog";
import { ProbisDetailPanel } from "@/components/dashboard/probis/probis-detail-panel";
import { ProbisFormDialog } from "@/components/dashboard/probis/probis-form-dialog";
import { ProbisTree } from "@/components/dashboard/probis/probis-tree";
import { Button } from "@/components/ui/button";
import { Card } from "@/components/ui/card";
import { ScrollArea } from "@/components/ui/scroll-area";
import { useTRPC } from "@/utils/trpc";

export const Route = createFileRoute("/dashboard/probis")({
  component: ProbisPage,
});

...
import { OpdDeleteDialog } from "@/components/dashboard/opd/opd-delete-dialog";
import { OpdFormDialog } from "@/components/dashboard/opd/opd-form-dialog";
import { OpdTable } from "@/components/dashboard/opd/opd-table";
import { Button } from "@/components/ui/button";
import { useTRPC } from "@/utils/trpc";

export const Route = createFileRoute("/dashboard/opd")({
  component: OpdPage,
});

...
import { ApplicationDeleteDialog } from "@/components/dashboard/aplikasi/application-delete-dialog";
import { ApplicationFormDialog } from "@/components/dashboard/aplikasi/application-form-dialog";
import { ApplicationTable } from "@/components/dashboard/aplikasi/application-table";
import { DuplicationCheckDialog } from "@/components/dashboard/aplikasi/duplication-check-dialog";
...
export const Route = createFileRoute("/dashboard/aplikasi")({
